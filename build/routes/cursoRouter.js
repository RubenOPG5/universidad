...
router.get('/cursos/listarCursos', CursoController_1.consultarPorFiltro);
//insertar
router.get('/creaCursos', CursoController_1.mostrarFormularioCrearCurso);
router.post('/', (0, CursoController_1.validar)(), CursoController_1.insertar);
//modificar
router.get('/modificaCurso/:id', CursoController_1.formularioModificar);
router.get('/modificaCurso/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const curso = yield (0, CursoController_1.formularioModificar)(req, res);
        if (!curso) {
...
//eliminar
router.delete('/:id', CursoController_1.eliminar); ///:idestudiante
